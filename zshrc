...
### bullet-train custom configurations
# Define default user (this way bullet train doesn't display unneeded information)
DEFAULT_USER="seimori"
# Stop display of context if it's default user
BULLETTRAIN_CONTEXT_DEFAULT_USER=(none)
# Change background color of user display
